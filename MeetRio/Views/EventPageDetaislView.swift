    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            if let address = event.address {
                ...
                MapView(coordinate: CLLocationCoordinate2D(latitude: address.location.latitude, longitude: address.location.longitude), appleMapsURL: URL(string: address.location.mapURL ?? ""))
