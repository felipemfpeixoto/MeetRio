                ...
                VStack {
                    HStack {
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            NavigationLink(destination: AuthenticationView(isShowing: $isShowing, arbiuPrimeiraVez: $arbiuPrimeiraVez, didStartSignUpFlow: $didStartSignUpFlow, willLoad: $willLoad))
                            {
                                ZStack {
